...
<head>
  ...
  <script src="${request.static_url('tools_compulife:static/jquery.min.js')}"></script>
  <script src="${request.static_url('tools_compulife:static/bootstrap/js/bootstrap.min.js')}"></script>
